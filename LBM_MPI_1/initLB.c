...
{
   int size_x = 5 * ((xlength[1]+1)*(xlength[2]+1)),size_y=5*((xlength[0]+1)*(xlength[2]+1)),size_z=5*((xlength[0]+1)*(xlength[1]+1)) ;
...
void extract(double*(sendBuffer[]),double*collideField,int*xlength)
{
            ...
            for (y = 0; y <= xlength[1] + 1; y++)
            {
                ...
                sendBuffer[0][5*(z*(xlength[2]+1)+y)+0] = collideField[PARAMQ*cellindex + 13] ;
                sendBuffer[0][5*(z*(xlength[2]+1)+y)+1] = collideField[PARAMQ*cellindex + 3] ;
                sendBuffer[0][5*(z*(xlength[2]+1)+y)+2] = collideField[PARAMQ*cellindex + 10] ;
                sendBuffer[0][5*(z*(xlength[2]+1)+y)+3] = collideField[PARAMQ*cellindex + 17] ;
                sendBuffer[0][5*(z*(xlength[2]+1)+y)+4] = collideField[PARAMQ*cellindex + 7] ;
            }
            ...
            {
                cellindex = z * (xlength[0] + 2) * (xlength[1] + 2) + y * (xlength[0] + 2) + x ;
                sendBuffer[1][5*(z*(xlength[2]+1)+y)+0] = collideField[PARAMQ*cellindex + 11] ;
                sendBuffer[1][5*(z*(xlength[2]+1)+y)+1] = collideField[PARAMQ*cellindex + 1] ;
                sendBuffer[1][5*(z*(xlength[2]+1)+y)+2] = collideField[PARAMQ*cellindex + 8] ;
                sendBuffer[1][5*(z*(xlength[2]+1)+y)+3] = collideField[PARAMQ*cellindex + 15] ;
                sendBuffer[1][5*(z*(xlength[2]+1)+y)+4] = collideField[PARAMQ*cellindex + 5] ;
            }
            ...
            {
                cellindex = z * (xlength[0] + 2) * (xlength[1] + 2) + y * (xlength[0] + 2) + x ;
                sendBuffer[2][5*(x*(xlength[0]+1)+z)+0] = collideField[PARAMQ*cellindex + 4] ;
                sendBuffer[2][5*(x*(xlength[0]+1)+z)+1] = collideField[PARAMQ*cellindex + 11] ;
                sendBuffer[2][5*(x*(xlength[0]+1)+z)+2] = collideField[PARAMQ*cellindex + 12] ;
                sendBuffer[2][5*(x*(xlength[0]+1)+z)+3] = collideField[PARAMQ*cellindex + 13] ;
                sendBuffer[2][5*(x*(xlength[0]+1)+z)+4] = collideField[PARAMQ*cellindex + 18] ;
            }
            ...
            {
                cellindex = z * (xlength[0] + 2) * (xlength[1] + 2) + y * (xlength[0] + 2) + x ;
                sendBuffer[3][5*(x*(xlength[0]+1)+x)+0] = collideField[PARAMQ*cellindex + 0] ;
                sendBuffer[3][5*(x*(xlength[0]+1)+x)+1] = collideField[PARAMQ*cellindex + 5] ;
                sendBuffer[3][5*(x*(xlength[0]+1)+x)+2] = collideField[PARAMQ*cellindex + 6] ;
                sendBuffer[3][5*(x*(xlength[0]+1)+x)+3] = collideField[PARAMQ*cellindex + 7] ;
                sendBuffer[3][5*(x*(xlength[0]+1)+x)+4] = collideField[PARAMQ*cellindex + 14] ;
            }
            ...
            {
                cellindex = z * (xlength[0] + 2) * (xlength[1] + 2) + y * (xlength[0] + 2) + x ;
                sendBuffer[4][5*(y*(xlength[1]+1)+x)+0] = collideField[PARAMQ*cellindex + 4] ;
                sendBuffer[4][5*(y*(xlength[1]+1)+x)+1] = collideField[PARAMQ*cellindex + 1] ;
                sendBuffer[4][5*(y*(xlength[1]+1)+x)+2] = collideField[PARAMQ*cellindex + 2] ;
                sendBuffer[4][5*(y*(xlength[1]+1)+x)+3] = collideField[PARAMQ*cellindex + 3] ;
                sendBuffer[4][5*(y*(xlength[1]+1)+x)+4] = collideField[PARAMQ*cellindex + 0] ;
            }
            ...
            {
                cellindex = z * (xlength[0] + 2) * (xlength[1] + 2) + y * (xlength[0] + 2) + x ;
                sendBuffer[5][5*(y*(xlength[1]+1)+x)+0] = collideField[PARAMQ*cellindex + 18] ;
                sendBuffer[5][5*(y*(xlength[1]+1)+x)+1] = collideField[PARAMQ*cellindex + 15] ;
                sendBuffer[5][5*(y*(xlength[1]+1)+x)+2] = collideField[PARAMQ*cellindex + 16] ;
                sendBuffer[5][5*(y*(xlength[1]+1)+x)+3] = collideField[PARAMQ*cellindex + 17] ;
                sendBuffer[5][5*(y*(xlength[1]+1)+x)+4] = collideField[PARAMQ*cellindex + 14] ;
            }
}
...
void swap_send_read( double**sendBuffer ,double**readBuffer ,int*xlength,int il,int ir,int jb,int jt,int kf,int kb,int myrank)
{
   int size_x = 5 * ((xlength[1]+1)*(xlength[2]+1)),size_y=5*((xlength[0]+1)*(xlength[2]+1)),size_z=5*((xlength[0]+1)*(xlength[1]+1)) ;
   MPI_Status status;
